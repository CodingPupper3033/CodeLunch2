...
public class SearchSchoolHandler implements Response.Listener, Response.ErrorListener {
    ...
    public SearchSchoolHandler(Activity activity, RecyclerView reloadRecyclerView, NutrisliceFinder finder, JSONObject item) throws JSONException {
            ...
            builder.setItems(convertDataToNameList(resultsArray), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        SearchMenusHandler searchMenusHandler = new SearchMenusHandler(activity, reloadRecyclerView, finder, menus_domain, jsonObject);
